            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" data-navbar-collapse="data-navbar-collapse">
                <div class="container d-lg-flex justify-content-lg-end pe-lg-0 w-lg-100">
                    <ul class="navbar-nav mt-2 mt-lg-1 ms-lg-4 ms-xl-8 ms-2xl-9 gap-lg-x1" data-navbar-nav="data-navbar-nav">
                        <li class="nav-item"> <a class="nav-link nav-bar-item px-0" href="index.php" title="home">Inicio</a></li>
                        <li class="nav-item"> <a class="nav-link nav-bar-item px-0" href="libros.php" title="about">Libros</a></li>
                        <li class="nav-item"> <a class="nav-link nav-bar-item px-0" href="autores.php" title="catalog">Autores</a></li>
